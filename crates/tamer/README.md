...
Skeleton. Primitives are added **on demand, driven by real downstream needs** —
not speculatively. See the crate-level docs (`src/lib.rs`) for the pattern each
new primitive follows.
