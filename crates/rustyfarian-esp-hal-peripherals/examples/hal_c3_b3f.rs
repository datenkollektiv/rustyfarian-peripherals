...
//! count over UART0 via `esp-println` — visible on the same `usbserial` bridge
//! port used to flash and monitor (no native USB connection needed).
//!
...
//! Avoid GPIO 8 / GPIO 9 (strapping / BOOT) and GPIO 20 / GPIO 21 (UART0 RX/TX,
//! used by `esp-println` for console output).
//!
//! ## Build
//!
//! ```sh
