...
- [ ] Core implementation (`tamer::range_map::RangeMap`)
- [ ] Host tests passing (per **Required tests** above)
- [ ] Documentation updated (module docs, `prelude` export, LDR→backlight doctest, CHANGELOG)
